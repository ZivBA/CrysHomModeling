...
public class Blosum62 implements ScoringScheme {
	
	private final static double[][] blosum62 =
	...
	public double score(Position pos1, Position pos2) {
		return blosum62[((AminoAcidPosition) pos1).aminoAcidInd][((AminoAcidPosition) pos2).aminoAcidInd];
	}
