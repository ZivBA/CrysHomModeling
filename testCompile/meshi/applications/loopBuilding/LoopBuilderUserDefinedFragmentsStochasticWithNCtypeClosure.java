...
//
//	private final double GAP_CUTOFF=8.0; // The building tree is pruned if the gap score is above this value
//
...
//	private int closureRes=-1;
//	private final double[] xyza = new double[4]; // An auxilary array
//
//	// Stats
