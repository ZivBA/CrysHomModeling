...
//private double[][] pp;
//
//public LoopRockHalf(Protein prot , int resBegin , int resEnd , int nIter , CommandList commands) {
//	this.prot = prot;
...
//	energyCreators[5] = new EVRot1BBCreator(1,pp,1000);
//	energyCreators[6] = new SolvateRot1Creator(1,pp,1000);
//	energyCreators[7] = new FlatRamachCreator(1.0);
...
//		double bestEne = 1e10;
//		double bestInd = 36;
//                rotateRes(c,-Math.PI/2.0);
//		for (int d=0 ; d< Math.round(180/angJump) ; d++) {
...
//		}
//                rotateRes(c,3*Math.PI/2.0);
//		System.out.println(bestInd + " " + bestEne);
//		rotateRes(c,-Math.PI/2.0 + bestInd*angJump*Math.PI/180.0);
//	}
//	// Now Minimizing
