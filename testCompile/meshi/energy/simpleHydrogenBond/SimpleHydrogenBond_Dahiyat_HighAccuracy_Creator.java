...
public class SimpleHydrogenBond_Dahiyat_HighAccuracy_Creator extends EnergyCreator {
	
	private boolean toCalcDerivatives = true;
	private DahiyatHighAccuracyParamaters parameters = null;

	public SimpleHydrogenBond_Dahiyat_HighAccuracy_Creator(double weight , boolean toCalcDerivatives) {
		super(weight);
		this.toCalcDerivatives = toCalcDerivatives;
		parameters = new DahiyatHighAccuracyParamaters();
	}

	public SimpleHydrogenBond_Dahiyat_HighAccuracy_Creator(double weight) {
		this(weight, true);
	}
