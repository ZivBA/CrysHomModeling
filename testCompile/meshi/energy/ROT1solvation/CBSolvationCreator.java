...
import meshi.energy.ROT1solvation.parameters.CBParametersGivenCutoff;
import meshi.geometry.DistanceMatrix;
import meshi.molecularElements.Protein;
import meshi.util.CommandList;

public class CBSolvationCreator extends EnergyCreator {
	...
	public CBSolvationCreator(double weight, String cutoff , boolean toCalcDerivatives) {
		this(weight, cutoff ,toCalcDerivatives, null);
	}
	
	public CBSolvationCreator(double weight, String cutoff , boolean toCalcDerivatives, boolean[] matchingRes) {
		super(weight);
	...
	public CBSolvationCreator(double weight, String cutoff) {
	...
	public AbstractEnergy createEnergyTerm(Protein protein,
		...
		if (parameters== null) {			
	    	...
	    	parameters = new CBParametersGivenCutoff(fullPathName,cutoff);
	 	}
