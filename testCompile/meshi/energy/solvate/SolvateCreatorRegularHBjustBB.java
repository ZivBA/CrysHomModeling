...
/**
 * The different between this creator and the "SolvateCreatorRegularHB" is that only BB hydrogen bonds are considered here.
 **/

public class SolvateCreatorRegularHBjustBB extends EnergyCreator  implements KeyWords {
    ...
    public SolvateCreatorRegularHBjustBB(double weightSCPolarSolvate, double weightSCCarbonSolvate, 
    ...
    public SolvateCreatorRegularHBjustBB(double weight) {
		super(weight);
    ...
    public SolvateCreatorRegularHBjustBB() {
