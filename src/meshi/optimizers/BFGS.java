...
public class BFGS extends Minimizer {
    ...
    public BFGS(TotalEnergy energy, CommandList commands) {
	super(energy, commands);
	getParameters(DEFAULT_ALLOWED_MAX_H_FACTOR * energy.coordinates().length,
		      DEFAULT_MAX_NUM_KICK_STARTS,
		      DEFAULT_C1, DEFAULT_C2,
		      DEFAULT_EXTENDED_ALPHA_FACTOR_WOLF_SEARCH,
		      DEFAULT_MAX_NUM_EVALUATIONS_WOLF_SEARCH,
   ...
   //Full constructor
    ...
    private void kickStart() throws MinimizerException,LineSearchException {
    	...
    	{
	    if (e.code != 2)
		throw e; //Differentiation error, or some other irrecoverable error 
    	}
    	finally
    	{
