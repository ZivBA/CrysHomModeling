...
//class FastAndDirtySCModeling implements Residues,
//		AtomTypes, KeyWords { /**
//								      * The implemented
...
//    private final int[] seder = {18,19,6,4,9,10,3,8,14,2,13,11,1,12,16,7,17,15};
//    private final double[] w1 = {0.00,0.08,1.78,0.22,2.42,0.00,1.40,0.08,0.50,
//			   0.72,0.92,0.32,0.30,0.56,0.30,0.10,0.14,0.04,8.54,7.56};
//    private final double[] w2 = {0.00,0.02,0.74,0.00,1.04,0.00,1.20,0.10,0.00,
...
//
//
//    private double[] brain(int resnum, double prob) {
//
...
//
//
//    private void onSOL(TotalEnergy te) {
//        AbstractEnergy[] energyTerms = te.getEnergyTerms(new SolvateEnergy());
//        for (int c=0 ; c<energyTerms.length ; c++)
//	    energyTerms[c].on();
//    }
//
//    private void offSOL(TotalEnergy te) {
//        AbstractEnergy[] energyTerms = te.getEnergyTerms(new SolvateEnergy());
//        for (int c=0 ; c<energyTerms.length ; c++)
//	    energyTerms[c].off();
//    }
//
//    private void onEV(TotalEnergy te) {
