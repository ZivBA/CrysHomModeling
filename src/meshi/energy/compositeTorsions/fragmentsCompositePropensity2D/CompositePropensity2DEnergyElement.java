...
public class CompositePropensity2DEnergyElement
	...
	/*
	 *This methods overide the one in EnergyElement, because in the fragment corpus version, I want a value of 1e-100
	 *to be added to each active element, and be concentrated in CA.
	 */
    public double evaluateAtoms() {
	double e = evaluate();
	residueTorsions.getResidue().ca().addEnergy(e+1e-100);
	return e;
    }
