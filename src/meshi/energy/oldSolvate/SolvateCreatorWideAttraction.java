...
public class SolvateCreatorWideAttraction extends EnergyCreator implements KeyWords {
    ...
    public SolvateCreatorWideAttraction(double cooperativeSolvateWeight, 
    ...
    public SolvateCreatorWideAttraction() {
    ...
    public AbstractEnergy createEnergyTerm(Protein protein, DistanceMatrix distanceMatrix,
		...
		if (parametersList== null) {
	    	...
	    	String[] strlist = new String[SOLVATE_WIDE_ATTRACTION_PARAMETERS.length];
	    	String pathname = parametersDirectory(commands).concat("/");
	    	for (int cc=0 ; cc<SOLVATE_WIDE_ATTRACTION_PARAMETERS.length ; cc++)
	        	strlist[cc] = pathname.concat(SOLVATE_WIDE_ATTRACTION_PARAMETERS[cc]);
		...
		SolvateEnergy solvateEnergy = new SolvateEnergy(protein.atoms(), 
    				...
    				sigmoidEndsNoH,
					weight());
		solvateEnergy.setComment("SolvateWide");
