...
public class SimpleHydrogenBond_Dahiyat_LowAccuracy_BBonly_Creator extends EnergyCreator {
	...
	public SimpleHydrogenBond_Dahiyat_LowAccuracy_BBonly_Creator(double weight) {
		this(weight, true);
	}
