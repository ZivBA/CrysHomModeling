...
public class SimpleHydrogenBond_Dahiyat_Minimization_NoDuplications_Creator extends EnergyCreator {

	private boolean toCalcDerivatives = true;
	private DahiyatMinimizationParameters parameters = null;

	private SimpleHydrogenBond_Dahiyat_Minimization_NoDuplications_Creator(double weight, boolean toCalcDerivatives) {
		super(weight);
		this.toCalcDerivatives = toCalcDerivatives;
		parameters = new DahiyatMinimizationParameters();
	}

	public SimpleHydrogenBond_Dahiyat_Minimization_NoDuplications_Creator(double weight) {
		this(weight, true);
	}

	public AbstractEnergy createEnergyTerm(Protein protein,
			DistanceMatrix distanceMatrix, CommandList commands) {
		return new SimpleHydrogenBondEnergy(new DahiyatHydrogenBondListNoDuplications(distanceMatrix, protein.atoms(), parameters),
				distanceMatrix,
				weight(),
				toCalcDerivatives);
	}
