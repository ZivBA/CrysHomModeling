...
import meshi.energy.ROT1solvation.parameters.RandomParametersGivenCutoff;
import meshi.geometry.DistanceMatrix;
import meshi.molecularElements.Protein;
import meshi.util.CommandList;

public class RandomSolvationCreator extends EnergyCreator {
	...
	public RandomSolvationCreator(double weight, String cutoff) {
	...
	public AbstractEnergy createEnergyTerm(Protein protein,
		...
		if (parameters== null) {			
	    	...
	    	parameters = new RandomParametersGivenCutoff(fullPathName,cutoff);
	 	}
