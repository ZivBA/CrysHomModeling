...
//class MassList implements ResidueMasses {
//
//	public MassList() {}
//
...
//
//
//	private double getMass(String seq) {
//		double mass = 0.0;
...
//	}
//
//	private double[] getMasses(Digestion digest, int pepInd) {
//		return getMasses(digest.getSeq(pepInd));
//	}
//
//	private double[] getMasses(String seq) {
