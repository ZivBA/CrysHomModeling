...
//				System.out.println("Match:\n" + lines[c] + "\n" + alMeshi.atomAt(minInd));
	...
	public String getTorsionRestrainString(double[][] pp) {
		...
		TorsionList modelChi1 = (TorsionList) TorsionList.createTorsionList(meshiProtein,
				distanceMatrix).filter(new TorsionList.FilterChi1() , new TorsionList());
		TorsionList modelChi2 = (TorsionList) TorsionList.createTorsionList(meshiProtein,
				distanceMatrix).filter(new TorsionList.FilterChi2() , new TorsionList());
		TorsionList modelChi3 = (TorsionList) TorsionList.createTorsionList(meshiProtein,
