 ...
 * @author Nir
 */
public class TestPairwiseCoarseEnergiesCenters extends MeshiProgram implements Residues, AtomTypes, MeshiPotential, KeyWords, CompositeTorsionsDefinitions{
    ...
    static double[] scSA = {20, //a
       ...
       160, //w
       135}; //y 
    static double bbSA = 55.0/75.0;  // Should be 95,  but this is without hydrogen bonding in a SS;
