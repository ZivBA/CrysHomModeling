...
import meshi.energy.disConst.DisConstCreator;
...
public class MinimizeBatchOfProteinsSoftConst extends MeshiProgram implements Residues, AtomTypes {
	...
	public static void main(String[] args) throws MinimizerException, LineSearchException {
		...
		EnergyCreator[] energyCreators = {
				...
				new DisConstCreator(4.0,15,2,new AtomList.ClassNCaCFilter())
		};	
